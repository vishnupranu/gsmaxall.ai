"""GSMAXALL — media service.

Image/audio generation and understanding
...
SERVICE_NAME = "media"
SERVICE_PORT = int(os.environ.get("PORT", "8087"))
...
def info() -> dict[str, str]:
    return {
        ...
        "description": "Image/audio generation and understanding",
        "status": "scaffolded",
    }
